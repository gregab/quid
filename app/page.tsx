    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-stone-50 via-amber-50 to-stone-100 dark:from-stone-950 dark:via-stone-900 dark:to-stone-950">
      ...
      <main className="flex flex-1 items-center justify-center p-4">
        <div className="w-full max-w-md text-center">
          {/* Hero card */}
          <div className="landing-card overflow-hidden rounded-3xl shadow-xl">
            <div className="relative overflow-hidden bg-gradient-to-br from-stone-700 via-stone-600 to-amber-700 px-8 py-16 sm:py-14 text-white">
              ...
              <div className="relative z-10">
                ...
                <h1
                  className="mb-3 text-4xl sm:text-3xl tracking-tight text-white"
                  style={{ fontFamily: "var(--font-serif-logo)", fontWeight: 400 }}
                >
                  Aviary
                </h1>
            ...
            <div className="bg-white px-8 py-8 dark:bg-stone-900">
              {user ? (
                <Link
                  href="/dashboard"
                  className="block w-full rounded-xl bg-amber-600 py-3 text-center text-sm font-bold text-white shadow-sm transition-all duration-150 hover:bg-amber-700 active:scale-[0.97]"
                >
                ...
                <div className="space-y-3">
                  ...
                  <Link
                    href="/signup"
                    className="block w-full rounded-xl border border-stone-200 py-3 text-center text-sm font-bold text-stone-700 shadow-sm transition-all duration-150 hover:bg-stone-50 active:scale-[0.97] dark:border-stone-700 dark:text-stone-200 dark:hover:bg-stone-800"
                  >
                    Sign up
                  </Link>
                </div>
